...
• teraboxapp.com / www.teraboxapp.com / terabox.app / www.terabox.ap / terabox.fun
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        buffer.seek(0)
        await fetching_msg.delete()
        await update.message.reply_video(video=buffer, filename=filename, caption=f"📁 {filename}\n📊 {file_size}\n\n{FOOTER}", parse_mode='Markdown')
...
# Send file with clickable button
...
# Handle inline button click (optional)
